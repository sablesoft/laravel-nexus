    ...
    public function run()
    {
        ...
        \DB::table('app.notes')->insert(array (
            ...
            array (
                'id' => 35,
                'user_id' => 3,
                'title' => '{"en":"Quest - Gasoline"}',
            'content' => '{"en":"The player\'s urgent task is to find gasoline.\\n\\nThe quest must be directly tied to the current situation: the player’s fuel is running critically low, and they have just pulled over near an abandoned house spotted from the rural road.\\n\\nThe quest must be:\\n- urgent but grounded,\\n- plausible within the current environmental context,\\n- and immediately connected to the player\'s pressing survival need (running out of fuel).\\n\\nImportant:\\n- The quest card must not specify whether gasoline is actually present, nor its precise location within the house or surroundings.\\n- The existence and discovery of gasoline must remain uncertain until the player actively investigates.\\n- The motivation must be logical and pragmatic: securing gasoline is necessary for continuing their journey and avoiding being stranded.\\n\\nAlso ensure:\\nThe quest initiates because of the observed proximity of the house and the urgent need for fuel.\\nSearching for gasoline must feel like a realistic, sensible action based on what the player sees and knows.\\n\\nBe clear, structured, and purpose-driven. Focus on tangible objectives and system-relevant information rather than emotional tone or storytelling flair."}',
                'created_at' => '2025-04-25 23:12:08',
                'updated_at' => '2025-04-25 23:12:08',
            ),
        ));
