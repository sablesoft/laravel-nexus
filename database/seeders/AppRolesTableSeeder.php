...
class AppRolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('app.roles')->insert(array (
            ...
            'behaviors' => '{"can": {"judge": "member.has(\'discipline\') >= 5", "protect": "member.has(\'rank\') === \'knight\'", "invoke-oath": true}}',
                'created_at' => '2025-04-06 03:32:21',
                'updated_at' => '2025-04-06 03:32:21',
            ),
            7 => 
            ...
            array (
                ...
                'is_public' => true,
                'states' => '{"has": {"range": {"type": "int", "value": 2, "description": "Effective psychic distance in zones or rooms."}, "clarity": {"type": "int", "value": 7, "description": "Focus and sensitivity to mental noise."}, "fatigue": {"type": "int", "value": 1, "description": "Mental strain accumulated from recent use."}, "link-active": {"type": "bool", "value": false, "description": "Is currently maintaining a mind link."}}}',
            'behaviors' => '{"can": {"link": "member.has(\'range\') >= 2", "read-mind": "member.has(\'clarity\') > 6", "detect-lie": true}}',
                'created_at' => '2025-04-06 03:32:21',
                'updated_at' => '2025-04-06 03:32:21',
            ),
            9 => 
            array (
                ...
                'is_public' => true,
                'states' => '{"has": {"focus": {"type": "int", "value": 5, "description": "Ability to concentrate on intricate tasks."}, "tools": {"type": "bool", "value": true, "description": "Has a toolkit available."}, "blueprints": {"type": "int", "value": 1, "description": "Number of known upgrade plans."}, "gadget-parts": {"type": "int", "value": 3, "description": "Parts available for crafting."}}}',
            ...
            array (
                ...
                'is_public' => true,
                'states' => '{"has": {"tension": {"type": "int", "value": 2, "description": "Current level of interpersonal or political stress."}, "charisma": {"type": "int", "value": 7, "description": "Personal appeal and persuasive ability."}, "language-pack": {"type": "bool", "value": true, "description": "Carries translation tools for alien or foreign communication."}, "favored-faction": {"type": "enum", "value": "Neutral", "options": ["Neutral", "Order", "Rebellion"], "description": "Current political alignment."}}}',
