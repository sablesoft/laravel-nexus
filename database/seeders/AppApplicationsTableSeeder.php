    ...
    public function run()
    {
        ...
        \DB::table('app.applications')->insert(array (
            ...
            array (
                ...
                'is_public' => true,
                'seats' => 1,
                'states' => '{"has": {"time": {"type": "enum", "value": "dawn", "options": ["dawn", "morning", "late_morning", "noon", "afternoon", "sunset", "evening", "night", "midnight", "late_night", "pre_dawn"]}, "weather": {"type": "enum", "value": "clear", "options": ["clear", "warm_breeze", "hazy", "cloudy", "overcast", "light_rain", "heavy_rain", "storm", "fog", "humid", "cold_drizzle", "frost", "snow", "blizzard", "dusty_wind"]}}}',
                'member_states' => NULL,
            ...
            'before' => '[{"comment":">>Prepare weather and time"},{"chat.state":{"weather":"chat.randomState(\'weather\')","time":"chat.randomState(\'time\')"}}]',
                ...
                'updated_at' => '2025-04-15 02:13:54',
            ),
        ));
