    ...
    public function run()
    {
        ...
        \DB::table('app.applications')->insert(array (
            ...
            'init' => '[{"comment":">>Prepare weather and time"},{"chat.state":{"weather":"chat.randomState(\'weather\')","time":"chat.randomState(\'time\')"}}]',
                ...
                'updated_at' => '2025-04-15 16:30:12',
            ),
        ));
