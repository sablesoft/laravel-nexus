    ...
    public function run()
    {
        ...
        \DB::table('app.screens')->insert(array (
            ...
            array (
                ...
                'updated_at' => '2025-04-19 09:25:20',
            ),
            2 => 
            array (
                'id' => 1,
            ...
            'init' => '[{"if":{"condition":"screen.state(\'step\') == 0","then":[{"comment":">>Greeting"},{"set":{"messages":"character_info"}},{"merge":{"messages":[{"role":">>system","content":"media.note(\'greetings\')"}]}},{"chat.completion":{"model":">>gpt-4o","async":true,"messages":"messages","content":[{"memory.create":{"content":"content"}},{"screen.state":{"values":{"step":"screen.nextState(\'step\')"}}},{"chat.refresh":null}]}},{"screen.waiting":true}]}}]',
                'before' => NULL,
                'after' => NULL,
                'created_at' => '2025-04-08 19:43:19',
                'updated_at' => '2025-04-19 09:15:43',
            ),
        ));
