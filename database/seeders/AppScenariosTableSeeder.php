    ...
    public function run()
    {
        ...
        \DB::table('app.scenarios')->insert(array (
            ...
            array (
                'id' => 9,
                'user_id' => 1,
                'title' => '{"en":"Prepare Location Generation"}',
                'description' => NULL,
            ...
            array (
                'id' => 14,
                'user_id' => 1,
                'title' => '{"en":"Smart Lift Description"}',
                'description' => NULL,
            ...
            array (
                'id' => 11,
                'user_id' => 1,
                'title' => '{"en":"Actions Classificator Tool"}',
                'description' => NULL,
            ...
            array (
                'id' => 12,
                'user_id' => 1,
                'title' => '{"en":"Smart Lift Main Actions"}',
                'description' => NULL,
