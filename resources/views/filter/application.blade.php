<flux:tooltip content="{{ __('Filter by Application') }}">
    <flux:select id="public" wire:model.live="filterApplicationId" placeholder="{{ __('Application') }}" class="cursor-pointer">
