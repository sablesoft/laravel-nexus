...
class AppIseed
{
    ...
    {
        return base_path('vendor/orangehill/iseed/src/Orangehill/Iseed/stubs');
    }
     ...
     * @return string
     */
    public function generateClassName($table, $prefix = null, $suffix = null): string
    {
        $tableString = '';
        $tableName = preg_split('/[_\.\-]/', $table);
        foreach ($tableName as $tableNamePart) {
            $tableString .= ucfirst($tableNamePart);
        }
